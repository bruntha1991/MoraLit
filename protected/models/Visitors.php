...
class Visitors extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('username, first_name, last_name, mail', 'required'),
			array('username, first_name, last_name, mail', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('username, first_name, last_name, mail', 'safe', 'on'=>'search'),
		);
	}
